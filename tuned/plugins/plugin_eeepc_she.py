...
class EeePCSHEPlugin(base.Plugin):
    ...
    def _instance_cleanup(self, instance):
        if instance.load_monitor is not None:
            self._monitors_repository.delete(instance.load_monitor)
            instance.load_monitor = None

    def load_monitor(self):
        return self._load_monitor

    def _instance_update_dynamic(self, instance, device):
        load = instance.load_monitor.get_load()["system"]
