...
class IrqbalancePlugin(base.Plugin):
    ...
    @staticmethod
    def _read_irqbalance_sysconfig():
        try:
    ...
    @staticmethod
    def _write_irqbalance_sysconfig(content):
        try:
    ...
    @staticmethod
    def _write_banned_cpus(sysconfig, banned_cpumask):
        return sysconfig + "IRQBALANCE_BANNED_CPUS=%s\n" % banned_cpumask

    @staticmethod
    def _clear_banned_cpus(sysconfig):
        lines = []
